...
main <- function(lang, filename, index) {
  ...
  ParameterVector[10] <- "-"#coef(nonlinear_model)["a"]#2+a
  ParameterVector[11] <- "-"#coef(nonlinear_model)["b"]#2+b
  ParameterVector[12] <- "-"#coef(nonlinear_model)["d"]#2+d
  ...
  ParameterVector[13] <- "-"#coef(nonlinear_model)["a"]#3+a
  ParameterVector[14] <- "-"#coef(nonlinear_model)["c"]#3+c
  ParameterVector[15] <- "-"#coef(nonlinear_model)["d"]#3+d
